...
interface ISearchResultPaneProps {
	...
	onRowDoubleClicked: (context: Context, _: React.MouseEvent<HTMLDivElement, MouseEvent>) => void
	refCallback: (context: Context, element: HTMLDivElement | null) => void
}

const SearchResultPane = (props: ISearchResultPaneProps) => {
	const { items, selectedContextKeys, onRowClicked, onRowDoubleClicked, refCallback } = props
