...
const rowCellClassNames: Record<RowIdentifier, string> = {
    ...
    [RowIdentifier.DateModified]: "file-browser-grid-view__content__row__cell__date",
        ...
        <div className="file-browser-grid-view" ref={gridRef}>
            <div className="file-browser-grid-view__head">
                ...
                >
                    ...
                    >
                        <span className="file-browser-grid-view__head__name__text">Name</span>
                    </div>
                </Expandable>
                <Expandable
                    {...gridHeaderExpandableProps}
                    onWidthChanged={(w) => onHeaderWidthChanged(RowIdentifier.DateModified, w)}
                >
                    <div
                        className={`file-browser-grid-view__head__date ${NO_SELECT_CLASS}`}
                    >
                        <span className="file-browser-grid-view__head__date__text">Date modified</span>
                    </div>
                </Expandable>
                <Expandable
                    {...gridHeaderExpandableProps}
                ...
                >
                    ...
                    >
                        <span className="file-browser-grid-view__head__type__text">Type</span>
                    </div>
                </Expandable>
                <Expandable
                    {...gridHeaderExpandableProps}
                ...
                >
                    ...
                    >
                        <span className="file-browser-grid-view__head__size__text">Size</span>
                    </div>
                </Expandable>
            </div>
                        ...
                        >
                            ...
                            >
                                <div className="file-browser-grid-view__content__row__cell__name__inner">
                                    {icon}
                                    <span className="file-browser-grid-view__content__row__cell__name__text">{e.fullName}</span>
                                </div>
                            </div>
                            <div
                                className={`${rowCellClassNames[RowIdentifier.DateModified]} ${NO_SELECT_CLASS}`}
                            >
                                <span className="file-browser-grid-view__content__row__cell__date__text">{formattedDate}</span>
                            </div>
                            <div
                                className={`${rowCellClassNames[RowIdentifier.Type]} ${NO_SELECT_CLASS}`}
                            >
                                <span className="file-browser-grid-view__content__row__cell__type__text">{fileTypeDescriptor}</span>
                            </div>
                            <div
                                className={`${rowCellClassNames[RowIdentifier.Size]} ${NO_SELECT_CLASS}`}
                            >
                                <span className="file-browser-grid-view__content__row__cell__size__text">{0}</span>
                            </div>
                        </div>
                    )
                })}
