...
import { FILETYPE_EXECUTABLE, LEAF_EXTENSION_PROPERTY_NAME } from "../../../../constants"
...
const ApplicationsSection = (props: IApplicationsSectionProps) => {
    ...
    const [applicationInformation, setApplicationInformation] = useState<INonRootContextInformation[]>([])

    useEffect(() => {
        const apps = nonRootContextInformation
            .filter(ci => LEAF_EXTENSION_PROPERTY_NAME in ci.context && ci.context.extension === FILETYPE_EXECUTABLE)
