...
const SearchBar = (props: ISearchBarProps) => {
    ...
    const onSearchBarClicked = (_: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
        if (inputRef.current) {
    ...
    return (
        <div className="search-bar" onClick={onSearchBarClicked}>
            ...
            <input
                ...
                {...props}
            />
            {value && <CancelIcon className="search-bar__cancel-icon" height={20} width={20} onClick={onCancelClickedInternal} />}
        </div>
