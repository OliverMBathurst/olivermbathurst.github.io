...
interface IFileBrowserContext {
	...
	setNavigationHistoryForWindow: (
		windowId: string,
		updateFn: (history: BranchingContext[]) => BranchingContext[]
	) => void
	setTreeOpenFolderContextKeysForWindow: (
		windowId: string,
		updateFn: (contextKeys: string[]) => string[]
	) => void
...
export const FileBrowserContext = createContext<IFileBrowserContext>({
	...
	setNavigationHistoryForWindow: (
		_: string,
		__: (history: BranchingContext[]) => BranchingContext[]
	) => Function.prototype,
	setSelectedTreeContextKeysForWindow: (
		_: string,
		__: (contextKeys: string[]) => string[]
	) => Function.prototype,
	setTreeOpenFolderContextKeysForWindow: (
		_: string,
		__: (contextKeys: string[]) => string[]
...
const FileBrowserContextProvider = (
	props: IFileBrowserContextProviderProps
) => {
	...
	const [navigationHistory, setNavigationHistory] = useState<
		Record<string, BranchingContext[]>
	>({})
	const [historyPointers, setHistoryPointers] = useState<
		Record<string, number>
	>({})
	const [treeSelectedContextKeys, setTreeSelectedContextKeys] = useState<
		Record<string, string[]>
	>({})
	const [treeOpenFolderContextKeys, setTreeOpenFolderContextKeys] = useState<
		Record<string, string[]>
	>({})
	...
	const setNavigationHistoryForWindow = (
		windowId: string,
		updateFn: (history: BranchingContext[]) => BranchingContext[]
	) => {
	...
	const setSelectedTreeContextKeysForWindow = (
		windowId: string,
		updateFn: (contextKeys: string[]) => string[]
	) => {
	...
	const setTreeOpenFolderContextKeysForWindow = (
		windowId: string,
		updateFn: (contextKeys: string[]) => string[]
	) => {
