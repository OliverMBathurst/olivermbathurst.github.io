...
import { PdfIcon, InternetIcon, TextFileIcon, ExecutableFileIcon, GenericFileIcon, FolderIcon, DriveIcon, IIconProps } from "../icons";
import { Context } from "../types/fs";

export const getIcon = (context: Context, props?: IIconProps): JSX.Element | null => {
